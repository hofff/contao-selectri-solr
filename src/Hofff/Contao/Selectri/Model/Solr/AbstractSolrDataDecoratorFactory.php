...
abstract class AbstractSolrDataDecoratorFactory implements DataFactory {
	...
	public function createData(Widget $widget = null) {
		...
		return $this->createDecorator($decoratedData, $config);
	}
	 ...
	 * @return Data
	 */
	protected abstract function createDecorator(Data $decoratedData, SolrDataConfig $config);
